...
https://github.com/netology-code/mnt-homeworks/tree/master/09-ci-01-intro
...
<workflow>
  <meta name="jira.description">Open</meta>
  <meta name="jira.update.author.id">557058:39021990-fa62-430c-aec8-b4e8153f6044</meta>
  <meta name="jira.update.author.key">557058:39021990-fa62-430c-aec8-b4e8153f6044</meta>
  <meta name="jira.updated.date">1636890139256</meta>
  <initial-actions>
  ...
  <steps>
    ...
    <step id="3" name="Done reproduce">
      ...
      <actions>
        <action id="41" name="Done reproduce -&gt; On reproduce">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="2">
        ...
        <action id="51" name="Done reproduce -&gt; On fix">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
    ...
    <step id="5" name="Done fix">
      ...
      <actions>
        ...
        <action id="91" name="Done fix -&gt; On fix">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="4">
    ...
    <step id="6" name="On test">
      ...
      <actions>
        <action id="101" name="On test -&gt; On fix">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="4">
        ...
        <action id="111" name="On test -&gt; Done">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
    ...
    <step id="7" name="Done">
      ...
      <actions>
        <action id="121" name="Done -&gt; Closed">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
    ...
    <step id="8" name="Closed">
      ...
      <actions>
        <action id="141" name="Closed -&gt; Done">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="7">
...
<!DOCTYPE workflow PUBLIC "-//OpenSymphony Group//DTD OSWorkflow 2.8//EN" "http://www.opensymphony.com/osworkflow/workflow_2_8.dtd">
<workflow>
  <meta name="jira.description">other tasks</meta>
  <meta name="jira.update.author.id">557058:39021990-fa62-430c-aec8-b4e8153f6044</meta>
  <meta name="jira.update.author.key">557058:39021990-fa62-430c-aec8-b4e8153f6044</meta>
  <meta name="jira.updated.date">1636798885961</meta>
  <initial-actions>
    <action id="1" name="Create">
      <validators>
        <validator name="" type="class">
  ...
  <steps>
    ...
    <step id="2" name="On develop">
      ...
      <actions>
        <action id="21" name="On develop -&gt; Open">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="1">
        ...
        <action id="31" name="On develop -&gt; Done develop">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="3">
    ...
    <step id="3" name="Done develop">
      ...
      <actions>
        <action id="41" name="Done develop -&gt; On develop">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="2">
        ...
        <action id="51" name="Done develop -&gt; On test">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="4">
    ...
    <step id="4" name="On test">
      ...
      <actions>
        ...
        <action id="71" name="On test -&gt; Done">
          <meta name="jira.description"></meta>
          <meta name="jira.fieldscreen.id"></meta>
          <results>
            <unconditional-result old-status="null" status="null" step="5">
